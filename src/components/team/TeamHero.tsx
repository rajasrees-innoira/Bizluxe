...
export function TeamHero() {
  return (
    <section className="relative h-[85vh] min-h-[560px] w-full overflow-hidden bg-[#0C0C0C] flex items-end" id="team-hero">
      ...
      <div className="relative z-10 container mx-auto px-6 md:px-12 pb-16 md:pb-24">
        ...
        <motion.h1
          ...
          className="font-heading font-extrabold uppercase leading-[0.95] tracking-[-0.02em] text-[#F7F5F2] text-[9vw] sm:text-6xl md:text-7xl lg:text-[5.5rem]"
        >
          The Team Behind
          <br />
